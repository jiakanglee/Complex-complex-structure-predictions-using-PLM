...
from sss import load_foldseek_ckpt
...
class ESMFold(nn.Module):
    def __init__(self, esmfold_config=None, **kwargs):
        ...
        ckpt_path = "SavaNet/esm2_t33_650M_UR50D_foldseek_plddt70_iter3699128.pt"
        config_path = "SavaNet/esm2_t33_650M_UR50D.json"
        self.esm, self.esm_dict = load_foldseek_ckpt(ckpt_path,config_path)
